...
```text
https://raw.githubusercontent.com/Nobeta-Work/iirose-avatar-adapter/main/dist/iirose-avatar-adapter.user.js
```

### 方案 2：jsDelivr CDN（访问可能更快）

```text
https://cdn.jsdelivr.net/gh/Nobeta-Work/iirose-avatar-adapter@main/dist/iirose-avatar-adapter.user.js
```

如果 CDN 没更新，可以先刷新缓存：

```text
https://purge.jsdelivr.net/gh/Nobeta-Work/iirose-avatar-adapter@main/dist/iirose-avatar-adapter.user.js
```
...
- `dist/iirose-avatar-adapter.user.js`